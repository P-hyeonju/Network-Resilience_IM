...
def RRW(G, source, terminal, target_node, p_i, num_samples):
    ...
    return Pr_net_failure_origin / Pr_net_failure_reliable_i

target_node = int(input("노드 i: "))
RRW_val = RRW(G, source, terminal, target_node, p_i, num_samples)
print(f"위험 감소 가치 척도 RRW = {RRW_val}")